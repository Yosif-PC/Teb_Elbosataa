...
if(rowToRemove){
    Archive_Order_LD.push(rowToRemove);
    //localStorage.setItem("Archive_Order_LD", JSON.stringify(Archive_Order));
    db.ref("Archive_Order_LD").set(Archive_Order_LD);
    ...
    db.ref("Delivary_Order_LD").set(Delivary_Order_LD);
